...
extends Button {
    ...
    public void drawScreen(int n, int n2, float f) {
        ...
        AliceMain.textManager.drawStringWithShadow(String.valueOf(new StringBuilder().append(this.setting.getName()).append(" \u00a77").append(this.setting.currentEnumName())), this.x + 2.3f, this.y - 4.0f - (float)LuigiGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
