...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (this.firstRun) {
            this.closestTarget = EntityUtil2.getTargetDouble(this.enemyRange.getValue());
        ...
        if (this.trapPlayer()) {
            if (this.stage == 1) {
                ...
                for (Entity entity : PistonCrystal.mc.world.loadedEntityList) {
                    if (!(entity instanceof EntityEnderCrystal) || (int)entity.posX != (int)this.toPlace.to_place.get((int)(this.toPlace.supportBlock + 1)).xCoord || (int)entity.posZ != (int)this.toPlace.to_place.get((int)(this.toPlace.supportBlock + 1)).zCoord) continue;
                    --this.stage;
                    break;
                }
                if (this.stage == 3) {
        ...
        if ((double)arrn4[1] - this.closestTarget.posY > -1.0) {
            ...
            if (structureTemp2.to_place != null) {
                if (this.blockPlayer.getValue().booleanValue()) {
                    ...
                    int[] arrn7 = new int[]{(int)(-vec3d.xCoord), (int)vec3d.yCoord, (int)(-vec3d.zCoord)};
    ...
    private boolean getMaterialsSlot() {
        ...
        for (n = 0; n < 9; ++n) {
            ...
            if (object == ItemStack.field_190927_a) continue;
    ...
    private boolean placeBlock(BlockPos blockPos, int n, double d, double d2) {
        ...
        Vec3d vec3d = new Vec3d((Vec3i)blockPos2).addVector(0.5 + d, 1.0, 0.5 + d2).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5));
        Block block2 = PistonCrystal.mc.world.getBlockState(blockPos2).getBlock();
        if (PistonCrystal.mc.player.inventory.getStackInSlot(this.slot_mat[n]) != ItemStack.field_190927_a) {
            ...
            if (this.rotate.getValue().booleanValue() || n == 1) {
                ...
                BlockUtil2.faceVectorPacketInstant(vec3d2);
            }
    ...
    public void breakCrystal() {
        ...
        if (object != null) {
            ...
            for (Object object3 : PistonCrystal.mc.world.loadedEntityList) {
                if (!(object3 instanceof EntityEnderCrystal) || (int)((Entity)object3).posX != (int)this.toPlace.to_place.get((int)(this.toPlace.supportBlock + 1)).xCoord || (int)((Entity)object3).posZ != (int)this.toPlace.to_place.get((int)(this.toPlace.supportBlock + 1)).zCoord) continue;
                bl = true;
                break;
            }
            if (!bl) {
                ...
                if (this.brokenRedstoneTorch && this.get_block(object3.getX(), object3.getY(), object3.getZ()) instanceof BlockAir) {
                    ...
                    EnumFacing enumFacing = BlockUtil2.getPlaceableSide((BlockPos)object3);
                    if (enumFacing != null) {
                        if (this.rotate.getValue().booleanValue()) {
                            BlockPos blockPos = object3.offset(enumFacing);
                            EnumFacing enumFacing2 = enumFacing.getOpposite();
                            Vec3d vec3d = new Vec3d((Vec3i)blockPos).addVector(0.5, 1.0, 0.5).add(new Vec3d(enumFacing2.getDirectionVec()).scale(0.5));
