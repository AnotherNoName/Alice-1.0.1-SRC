            ...
            for (int j = vec3i.getZ() - this.range.getValue(); j < vec3i.getZ() + this.range.getValue(); ++j) {
                for (int k = vec3i.getY() + this.rangeY.getValue(); k > vec3i.getY() - this.rangeY.getValue(); --k) {
                    ...
                    if (HoleESP.mc.world.getBlockState(blockPos.north()).getBlock() == Blocks.BEDROCK && HoleESP.mc.world.getBlockState(blockPos.east()).getBlock() == Blocks.BEDROCK && HoleESP.mc.world.getBlockState(blockPos.west()).getBlock() == Blocks.BEDROCK && HoleESP.mc.world.getBlockState(blockPos.south()).getBlock() == Blocks.BEDROCK && HoleESP.mc.world.getBlockState(blockPos.down()).getBlock() == Blocks.BEDROCK) {
                        RenderUtil.drawBoxESP(blockPos, this.rainbow.getValue() != false ? ColorUtil2.rainbow(Global.getInstance().rainbowHue.getValue()) : new Color(this.safeRed.getValue(), this.safeGreen.getValue(), this.safeBlue.getValue(), this.safeAlpha.getValue()), this.customOutline.getValue(), new Color(this.safecRed.getValue(), this.safecGreen.getValue(), this.safecBlue.getValue(), this.safecAlpha.getValue()), this.lineWidth.getValue().floatValue(), this.outline.getValue(), this.box.getValue(), this.boxAlpha.getValue(), true, this.height.getValue(), this.gradientBox.getValue(), this.gradientOutline.getValue(), this.invertGradientBox.getValue(), this.invertGradientOutline.getValue(), this.currentAlpha);
                        continue;
                    }
                    if (!BlockUtil2.isBlockUnSafe(HoleESP.mc.world.getBlockState(blockPos.down()).getBlock()) || !BlockUtil2.isBlockUnSafe(HoleESP.mc.world.getBlockState(blockPos.east()).getBlock()) || !BlockUtil2.isBlockUnSafe(HoleESP.mc.world.getBlockState(blockPos.west()).getBlock()) || !BlockUtil2.isBlockUnSafe(HoleESP.mc.world.getBlockState(blockPos.south()).getBlock()) || !BlockUtil2.isBlockUnSafe(HoleESP.mc.world.getBlockState(blockPos.north()).getBlock())) continue;
                    RenderUtil.drawBoxESP(blockPos, this.rainbow.getValue() != false ? ColorUtil2.rainbow(Global.getInstance().rainbowHue.getValue()) : new Color(this.red.getValue(), this.green.getValue(), this.blue.getValue(), this.alpha.getValue()), this.customOutline.getValue(), new Color(this.cRed.getValue(), this.cGreen.getValue(), this.cBlue.getValue(), this.cAlpha.getValue()), this.lineWidth.getValue().floatValue(), this.outline.getValue(), this.box.getValue(), this.boxAlpha.getValue(), true, this.height.getValue(), this.gradientBox.getValue(), this.gradientOutline.getValue(), this.invertGradientBox.getValue(), this.invertGradientOutline.getValue(), this.currentAlpha);
                }
            }
        }
    }
