    ...
    public void execute(String[] arrstring) {
        ...
        if (string2.equalsIgnoreCase("regular")) {
            try {
                ...
                QueueCommand.sendMessage(String.valueOf(new StringBuilder().append("Regular queue currently have: ").append(string3)));
            }
            ...
            try {
                ...
                QueueCommand.sendMessage(String.valueOf(new StringBuilder().append("Priority queue currently have: ").append(string4)));
            }
            catch (IOException iOException) {
                iOException.printStackTrace();
            }
