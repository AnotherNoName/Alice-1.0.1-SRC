...
import me.snow.aclient.util.TestUtil;
...
implements Util {
    ...
    public static double getRange(Vec3d vec3d) {
        return WorldUtils.mc.player.getPositionVector().addVector(0.0, (double)WorldUtils.mc.player.eyeHeight, 0.0).distanceTo(vec3d);
    }
