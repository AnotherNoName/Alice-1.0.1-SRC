    ...
    public static Hole getHole(BlockPos blockPos, int n) {
        ...
        if (WorldUtils.empty.contains((Object)WorldUtils.getBlock(blockPos)) && !WorldUtils.empty.contains((Object)WorldUtils.getBlock(blockPos.down()))) {
            ...
            for (BlockPos blockPos222 : arrblockPos) {
                if (!WorldUtils.empty.contains((Object)WorldUtils.getBlock(blockPos222))) continue;
            ...
            for (BlockPos blockPos4 : EnumFacing.values()) {
                if (!blockPos.add(blockPos4.getFrontOffsetX(), blockPos4.getFrontOffsetY(), blockPos4.getFrontOffsetZ()).equals((Object)blockPos3)) continue;
